...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentServiceImpl(CommentRepository commentRepository, PostService postService, UserServiceImpl userService) {
    ...
    public Response addComment(String userEmail, AddCommentRequest request) {
        ...
        User commentAuthor = userService.findByEmail(userEmail);
